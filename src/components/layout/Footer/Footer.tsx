...
const Footer = () => {
  return (
    <div className="w-full h-12.5 sm:h-20 flex justify-center items-center absolute bottom-0 overflow-hidden z-10 gap-4 sm:gap-8 text-gray-300 text-[11px] sm:text-sm font-light backdrop-blur-[2px] bg-black/10">
